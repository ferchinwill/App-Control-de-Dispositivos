...
<body>
    <div class="container-fluid px-4 py-10 my-5 text-center ">
        ...
        <div class="" id="scrollEffectText1" i="">
            <div class="">
                <div class="px-3">
                    <h3 class="fw-bold">Crear Nuevo Tipo de Dispositivo</h3>   
                    <form action="Device_Type_Post.php" method="POST" id="deviceForm" class="row g-3 justify-content-center">
                        <div class="col-md-2 text-center">
                            <label for="deviceTypeSelect" class="form-label">Selecciona el Tipo de Dispositivo:</label>
                            <select class="form-select" id="deviceTypeSelect" name="DeviceTypeName" required>
                                <option value="analogico">Analogico</option>
                                <option value="Estandar">Hibrido</option>
