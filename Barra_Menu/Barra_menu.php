<div class="lc-block d-grid gap-2 justify-content-center fade-in ">
            <div class="container">
                <div class="row pt-2">
                    ...
                    <div class="col-md-4 text-center py-4">
                        <div class="lc-block">
                            ...
                            <div class="lc-name">Tus</div>
                            <div class="lc-description">Dispositivos</div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center py-4">
                        <div class="lc-block">
                    ...
                    <div class="col-md-4 text-center py-4">
                        <div class="lc-block">
                            ...
                            <div class="lc-name">Historial</div>
                            <div class="lc-description">Dispositivos</div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center py-4">
                        <div class="lc-block">
                            ...
                            <div class="lc-name">Actualizar</div>
                            <div class="lc-description">Dispositivos</div>
                        </div>
                    </div>
                </div>
