...
/*para mandar a llamar el nombre de usuarios necesitamos una base de datos  */
...
http://127.0.0.1:4040
http://ea34-148-237-98-221.ngrok-free-.app-> http://localhost:7159/
...
if ($httpCode == 200) {
    ...
    if ($responseData !== null) {
        ...
        foreach ($responseData as $deviceType) {
            $deviceItem = "ID: " . $deviceType['deviceTypeId'] . ", Nombre: " . $deviceType['deviceTypeName'] . "<br>";
            // Dependiendo del dispositivo, almacenamos en la variable correspondiente
            if ($deviceType['deviceTypeId'] == 1018) {
                $deviceList1 .= $deviceItem;
            } elseif ($deviceType['deviceTypeId'] == $deviceType) {
                $deviceList2 .= $deviceItem;
            } elseif ($deviceType['deviceTypeId'] == $deviceType) {
                $deviceList3 .= $deviceItem;
            }
        }
    } else {
...
<body>
    <div class="container-fluid px-4 py-10 my-5 text-center ">
        ...
        <div editable="rich">
            <!-- ========== <h2 class="display-5 fw-bold"> <?php echo ", $nombre_usuario!"; ?>Tu Nombre</h2> ========== -->
            <h2 class="display-6 fw-bold text-start  Mis_Dispositivos" id="scrollEffectText1">Mis Dispositivos</h2>
